...
@Component({
  ...
  standalone: true,
  imports: [CommonModule, AdvancedSearchComponent, MaterialModule, FormsModule,
    ReactiveFormsModule,],
...
export class AdvancedSearchComponent implements OnInit {
  ...
  optionsTags: ITagsFilter[] = [{ name: 'story' }, { name: 'comment' }, { name: 'poll' },
  { name: 'pollopt' }, { name: 'show_hn' }, { name: 'ask_hn' }, { name: 'front_page' },
  { name: 'author_:USERNAME' }, { name: 'story_:ID' }];
